...
class UserSecurity(models.Model):
    ...
    isVerfiyByManager = models.BooleanField(default=False,verbose_name='تاییدیه مدیر')
    isPeymentuser = models.BooleanField(default=False,verbose_name='حق عضویت پرداخت شده ؟')
